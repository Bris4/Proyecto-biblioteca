...
@Transient
List<PrestamoLibro> prestamosLibros = new ArrayList<PrestamoLibro>();
...
public List<PrestamoLibro> getLista() {
	return prestamosLibros;
}
public void setLista(List<PrestamoLibro> lista) {
	prestamosLibros = lista;
}
}